The support demand for Winter is increasing, while the available time the founders have to give remains the same. These issues will be handled in time, however there are ways you can help:
