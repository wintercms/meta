...
- Does the pull request follow the [PSR-2 guidelines](https://www.php-fig.org/psr/psr-2/) and our own [Developer Guidelines](https://wintercms.com/docs/help/developer/guide)?
...
If a migration is also included with this version, it should be appended as an array item below the update. See [the documentation](https://wintercms.com/docs/plugin/updates#version-file) for examples of how the version update entries should be formatted.
